...
def find_strat_deq(mieff_dir, pressure, temp, dtdp , FOPI, nofczns,nstr,x_max_mult,
    ...
    while dtdp[nstr[1]-1] >= subad*grad_x[nstr[1]-1] :
        ...
        flux_net_ir_layer, flux_plus_ir_attop,photo_inputs_dict,_= profile_deq(it_max_strat, itmx_strat, conv_strat, convt_strat, nofczns,nstr,x_max_mult,
    ...
    pressure, temp, dtdp, profile_flag,qvmrs, qvmrs2, all_profiles, all_kzz,opd_cld_climate,g0_cld_climate,w0_cld_climate,flux_net_ir_layer,flux_plus_ir_attop,photo_inputs_dict,_ = profile_deq(it_max_strat, itmx_strat, conv_strat, convt_strat, nofczns,nstr,x_max_mult,
        temp,pressure, FOPI, t_table, p_table, grad, cp,opacityclass, grav, 
